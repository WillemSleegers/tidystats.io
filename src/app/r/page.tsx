      ...
      <Section>
        <div className="container-md my-md-4">
          ...
          <p>
            ...
            normally conduct analyses in R. The idea is that you run the
            analyses and store the output of each analysis in a variable. You
            then add these variables to a list and save the list to a file on
            your computer.
          </p>
          ...
          <ul className="list-disc list-inside">
            <li>
              <code>results</code>: A list you want to add the statistical
              output to. You can create an empty list with the{" "}
              <code>list()</code>
              function.
            </li>
            <li>
          ...
          <p>
            Optionally, you can also specify an identifier, the type of
            analysis, whether the analysis was preregistered, and/or additional
            notes. This meta-information will be added to the analysis when you
            add it to the list.
          </p>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              <code>notes</code>: A character string to add additional
              information which you may find fruitful.
            </li>
          </ul>

          <p>
            <code>write_stats()</code> is the function to save the statistics to
            a file on your computer. It requires a list containing the analyses
            as its first argument and a path name to a file on your computer as
            its second argument.
          </p>
          ...
          <p>
            ...
            tidystats package to get access to its functions and I load the
            dplyr package for access to the <code>{"%>%"}</code> operator.
          </p>
          ...
          <pre>
            <code>
              # t-test{"\n"}
              sleep_test {"<-"} t.test(extra ~ group, data = sleep, paired =
              TRUE){"\n\n"}# lm{"\n"}
          ...
          <p>
            ...
            use the <code>add_stats()</code> function to add each analysis to
            this list. I also add some additional meta-information such as
            whether the analysis was a primary analysis or preregistered.
          </p>
          ...
          <p>
            This produces a JSON file. The JSON file contains all statistics in
            a machine-readable format. If you want to check out what the file of
